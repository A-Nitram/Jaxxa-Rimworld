...
namespace Enhanced_Development.PersonalShields
{
    public class Apparel_PersonalNanoShield : Apparel
    {
        ...
        {
            Enhanced_Development.PersonalShields.Apparel_PersonalNanoShield.Gizmo_PersonalShieldStatus opt1 = new Enhanced_Development.PersonalShields.Apparel_PersonalNanoShield.Gizmo_PersonalShieldStatus();
            opt1.shield = this;
            yield return opt1;
        }
