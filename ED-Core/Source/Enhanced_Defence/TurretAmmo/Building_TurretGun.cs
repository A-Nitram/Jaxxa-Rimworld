    ...
    public class Building_TurretGun : RimWorld.Building_TurretGun
    {
        public override string GetInspectString()
        {
            ...
            if (base.powerComp != null)
            {
                ...
                stringBuilder.AppendLine("Power: " + -base.powerComp.powerOutput + " / " + (base.powerComp.PowerNet.CurrentEnergyGainRate() / CompPower.WattsToWattDaysPerTick) + " - Stored: " + base.powerComp.PowerNet.CurrentStoredEnergy().ToString("F0"));
            }
