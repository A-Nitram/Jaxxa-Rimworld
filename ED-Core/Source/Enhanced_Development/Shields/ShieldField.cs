...
namespace Enhanced_Development.Shields
{
    class ShieldField : IExposable
    {
        ...
        public void DrawSubField(Vector3 position, float shieldShieldRadius)
        {
            ...
            //UnityEngine.Graphics.DrawMesh(Enhanced_Development.ShieldUtils.Graphics.CircleMesh, matrix, SolidColorMaterials.NewSolidColorMaterial(new Color(colourRed, colourGreen, colourBlue, fade), ShaderDatabase.MetaOverlay), 0);
